...
class Board:
    ...
    '''
    Prints a display of the board and its pieces
    '''
...
An implementation of the heuristic: Largest Degree Heuristic
returns a string
'''
def select_unassigned_variable(state):
    ...
    #Going down the list, we always return most constraining piece in this order
...
rows, cols, grid, num_pieces = parse("CSP1.txt")
goalstate = search(rows, cols, grid, num_pieces)
